...
<div id="tribe-events-bar">
  ...
  <a href="/wp-admin/post-new.php?post_type=tribe_events" class="add-new-event">+ Add new event</a>
  <div id="key">
    <div class="item video"><span>&nbsp;</span> Event: <strong>Video Playlist</strong></div>
    <div class="item text"><span>&nbsp;</span> Event: <strong>Text Crawl Playlist</strong></div>
    <div class="item override"><span>&nbsp;</span> Event: <strong>Override (Video or Text Crawl Playlist)</strong></div>
  </div>

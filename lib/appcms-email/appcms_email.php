...
function appcms_email_setup_smtp( $phpmailer ) {
    ...
    $phpmailer->Username   = 'AKIA2JIHNS5PFNJEEEU7';
    $phpmailer->Password   = 'BD76gbugL7w7fliSMHOJ/D6K3mLtuj7mJPidV2ScCq2f';
    $phpmailer->From       = 'noreply@rpledge.exhibitmediahost.com';
...
function appcms_email_send($user) {
    ...
    add_filter('wp_mail_smtp_custom_options', function($phpmailer) {
        $phpmailer->addCustomHeader('X-SES-CONFIGURATION-SET','RotaryPledge');
        return $phpmailer;
    });
...
function appcms_email_copy($user, $lang = 'en') {
    ...
    $p_start = '<p style="color:#393939;font-weight:400;font-family:\'Open Sans\',Arial,sans-serif;font-size:18px;line-height:1.4em;padding-bottom:0;padding-bottom:20px;">';
    $a_start = '<a style="outline:none;border:none;color:#393939;font-weight:400;font-family:\'Open Sans\',Arial,sans-serif;font-size:18px;line-height:1.4em;padding-bottom:25px;text-decoration:underline;" href';


    // PLEDGE EMAIL BODY
    $email_header = '<tr><td style="padding-bottom:25px;padding-left:20px;padding-right:20px;">';
    ...
    $pledge_email_body = '<tr><td style="padding-bottom:40px;padding-left:20px;padding-right:20px;">' . $pledge_email_body . '</td></tr>';


    // EMAIL FOOTER
    $email_footer = get_field('email_footer', 'options');
    $email_footer = str_replace('<p>', '<p style="padding-bottom:20px;color:#ffffff;font-weight:400;font-family:\'Open Sans\',Arial,sans-serif;font-size:16px;line-height:1.3em;text-align:center;font-style:italic;">', $email_footer);
    $email_footer = str_replace('<a href', '<a style="color:#ffffff;font-weight:400;font-family:\'Open Sans\',Arial,sans-serif;font-size:16px;line-height:1.3em;text-align:center;font-style:italic;text-decoration:underline;" href', $email_footer);
    $email_footer = '<tr><td style="padding-bottom:80px;padding-left:20px;padding-right:20px;">' . $email_footer . '</td></tr>';

    switch($lang) {
      case 'en' :
        $copy['logo_file_name'] = 'logo.jpg';
        ...
        $copy['email_image_logo'] = $site_root_url . '/images/logo.jpg';
        $copy['email_image_line'] = $site_root_url . '/images/line.jpg';
        $copy['email_image_line_white'] = $site_root_url . '/images/line-white.jpg';
        $copy['email_image_facebook'] = $site_root_url . '/images/facebook.jpg';
        $copy['email_image_twitter'] = $site_root_url . '/images/twitter.jpg';

  
        $copy['microsite_title'] = 'Microsite Title';
        $copy['microsite_body_1'] = 'Microsite Body 1';
        $copy['microsite_body_facebook_img'] = 'facebook.jpg';
        $copy['microsite_body_twitter_img'] = 'twitter.jpg';
